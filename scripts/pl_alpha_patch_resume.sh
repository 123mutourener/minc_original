...
srun python light_main.py --data-root "${DATA_PATH}" --stage patch --batch-size 256 --tag random_sample_256 --gpus 4 --num-nodes 1 --resume accuracy/minc-epoch=09-valid_accuracy=0.80.ckpt --epochs 20